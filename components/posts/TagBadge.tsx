  ...
  return (
    <li className="relative inline-flex items-center">
      <Link href={`/tags/${encodeURIComponent(title)}`}>
        <a className="border border-gray-200 text-xs text-gray-600 font-light rounded-full px-4 py-2 m-1 hover:text-white hover:bg-pink-500 hover:border-pink-600">
